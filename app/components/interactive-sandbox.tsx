...
export function InteractiveSandbox({
  ...
  const handleSimulate = async () => {
    ...
    try {
      ...
      setTimeout(() => setPipelinePhase(3), 1500);
  ...
  return (
    ...
    >
      {/* Dynamic ambient backdrop aura based on state */}
      <motion.div
        animate={{
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-800/80 pb-6">
        <div>
          ...
          <p className="text-xs md:text-sm text-slate-400 mt-0.5">
            Test synchronous cross-chain credit re-underwriting on Creditcoin CC3 in real time
          </p>
        </div>
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-6 my-6">
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-slate-800/60 pb-4 mb-4">
            ...
            <span className="flex items-center gap-1 text-[11px] font-mono px-2.5 py-1 rounded-full bg-red-500/10 text-red-400 border border-red-500/20 animate-pulse">
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-slate-800/60 pb-4 mb-4">
            ...
            >
              {isResolved ? '✅ ALL CLEAR — PRIME TIER' : '○ AWAITING SIMULATION'}
            </span>
          </div>
