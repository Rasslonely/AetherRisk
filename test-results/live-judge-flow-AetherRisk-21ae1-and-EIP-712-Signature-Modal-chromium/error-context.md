...
- Name: live-judge-flow.spec.ts >> AetherRisk Grand-Prize E2E Judge Flow Suite >> Test 3: Hardware TEE Remote Attestation — AMD SEV-SNP Quote and EIP-712 Signature Modal
- Location: tests\e2e\live-judge-flow.spec.ts:66:7
...
Locator: locator('[data-testid="enclave-cert-modal"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="enclave-cert-modal"]')
