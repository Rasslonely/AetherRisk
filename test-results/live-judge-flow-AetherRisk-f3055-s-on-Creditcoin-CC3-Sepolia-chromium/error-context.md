...
- Name: live-judge-flow.spec.ts >> AetherRisk Grand-Prize E2E Judge Flow Suite >> Test 4: Verified On-Chain Contracts Explorer Modal — 5 Contracts on Creditcoin CC3 & Sepolia
- Location: tests\e2e\live-judge-flow.spec.ts:92:7
...
Locator: locator('[data-testid="verified-contracts-modal"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="verified-contracts-modal"]')
